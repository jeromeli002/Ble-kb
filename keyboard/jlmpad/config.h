...
#define CONF_PRODUCT_ID 0x514 /* 配置项目内显示的ProductID */
#define DEVICE_VER 0x0001 /* 硬件版本 */
#define MANUFACTURER "JL" /* 硬件制造商，用于蓝牙显示 */
#define PRODUCT "JL-MPad" /* 硬件名称，用于USB和蓝牙显示 */
...
// ws2812 RGB 配置
#define RGBLED_NUM 19 // 8   RGB灯数量
#define RGB_DI_PIN 25 // 10   RGB灯IO口
#define RGBLIGHT_ANIMATIONS
#define RGB_PWR_PIN 5 // P型-mos管
...
// 启用 LED 状态灯
//#define LED_STATUS_BLE 19// 蓝牙状态灯
//#define LED_STATUS_CHARGING 18// 充电状态灯
//#define LED_STATUS_USB 20// USB状态灯
//#define LED_BLE_CHANNEL1 20// 状态灯１
//#define LED_BLE_CHANNEL2 20// 状态灯２
//#define LED_BLE_CHANNEL3 20// 状态灯３
...
// 旋钮配置
#define ROTARY_ENCODER_A 6 // 19
#define ROTARY_ENCODER_B 7 // 20
#define ROTARY_ENCODER_POS 5,0 // 正向旋转映射到键盘的按键行列（Row，Col）
#define ROTARY_ENCODER_NEG 5,1 // 负向旋转映射到键盘的按键行列（Row，Col）

// OLED 屏幕配置
//#define SSD1306_SDA 15 // 22
//#define SSD1306_SCL 16 // 23
...
static const uint8_t row_pin_array[MATRIX_ROWS] = { 10, 11, 12, 13, 14, 17 };
static const uint8_t column_pin_array[MATRIX_COLS] = { 18, 19, 20, 22, 23, 24 };
