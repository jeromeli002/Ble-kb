...
#define CONF_VENDOR_ID 0x4377 /*483配置项目内显示的VendorID */
#define CONF_PRODUCT_ID 0x0515 /* 配置项目内显示的ProductID */
#define DEVICE_VER 0x0001 /* 硬件版本 */
#define MANUFACTURER "JL" /* 硬件制造商，用于蓝牙显示 */
#define PRODUCT "JL\u5de6\u624b-Pad" /* 硬件名词，用于蓝牙显示 */
...
#define ROTARY_ENCODER_POS 4,3 // 正向旋转映射到键盘的按键行列（Row，Col）
...
static const uint8_t row_pin_array[MATRIX_ROWS] = {23,20,18,14,12};
static const uint8_t column_pin_array[MATRIX_COLS] = {24,22,19,17};
