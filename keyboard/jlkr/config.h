...
#define PRODUCT_ID 0x0518 /* USB PID */
#define CONF_VENDOR_ID 0x4377 /* 配置项目内显示的VendorID */
#define CONF_PRODUCT_ID 0x0518 /* 配置项目内显示的ProductID */
#define DEVICE_VER 0x0001 /* 硬件版本 */
#define MANUFACTURER "JL" /* 硬件制造商，用于蓝牙显示 */
#define PRODUCT "JL\u53f3\u624b" /* 硬件名称，用于USB和蓝牙显示 */
...
// 旋钮配置
#define ROTARY_ENCODER_A 28 // 19
#define ROTARY_ENCODER_B 29 // 20
#define ROTARY_ENCODER_POS 6,0 // 正向旋转映射到键盘的按键行列（Row，Col）
#define ROTARY_ENCODER_NEG 6,1 // 负向旋转映射到键盘的按键行列（Row，Col）
...
static const uint8_t row_pin_array[MATRIX_ROWS] = { 23, 22, 20, 19, 18, 17, 13, 11 };
static const uint8_t column_pin_array[MATRIX_COLS] = { 23, 22, 20, 19, 18, 17, 13, 11 };
