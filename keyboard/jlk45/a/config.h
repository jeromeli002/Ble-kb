...
#define PRODUCT "\u7ae5\u5de5\u952e\u76d845" /* 硬件名称，用于USB和蓝牙显示 */
...
// ws2812 RGB 配置
#define RGBLED_NUM 45 // 8   RGB灯数量
#define RGB_DI_PIN 7 // 10   RGB灯IO口
#define RGBLIGHT_ANIMATIONS
#define RGB_PWR_PIN 6 // P型-mos管
...
// 独立硬件按钮
#define POWER_BUTTON 5 // 3

// 旋钮配置
#define ROTARY_ENCODER_A 17 // 19
#define ROTARY_ENCODER_B 18 // 20
